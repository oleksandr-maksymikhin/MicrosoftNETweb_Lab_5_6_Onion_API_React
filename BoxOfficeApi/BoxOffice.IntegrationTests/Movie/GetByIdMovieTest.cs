...
{
    public class GetByIdMovieTest: CosmosBaseTest
    {
        private readonly HttpClient _httpClient;
        public GetByIdMovieTest()
        {
        ...
        public async Task GetByIdAsync_IfNoExceptionOccurred_GetByIdEntityFromDb()
        {
            ...
            var getyIdResponseModel = JsonConvert.DeserializeObject<Model.Movie.Movie>(
            ...
            getyIdResponseModel.Title.Should().Be(inputModel_1.Title);
            getyIdResponseModel.Director.Should().Be(inputModel_1.Director);
            getyIdResponseModel.Poster.Should().Be(inputModel_1.Poster);
